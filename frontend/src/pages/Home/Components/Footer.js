    ...
    return (
        <div className='footer'>
            <div>
                <div className='footer-data'>
                    <div className="contact-details">
                        ...
                        <p> adress: el menzah5,Tunisia</p>
                        <p><b>Email:</b>library142@gmail.com</p>
                    </div>
            ...
            <div className='copyright-details'>
                <p className='footer-copyright'>&#169; 2024 copyright all right reserved<br /><span>Designed with ❤️ by Nour</span></p>
            </div>
        </div>
    )
}
